...
Full xfce4 desktop environment accessible via Remote Desktop Protocol (RDP), with:
...
The RDP port will be forwarded to 33890 on the host, and 1GB of shared memory will be allocated 
